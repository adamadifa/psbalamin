<div class="box">
    ...
    <div class="box-body">
		...
		<form class="form-horizontal" method="post" action = "<?php echo base_url(); ?>santri/editdaftaradmin">
			<div class="box-body">
				<input type="hidden" class="form-control" name="tingkat" value="<?php echo $santri['tingkat']; ?>"" >
				...
				<div class="form-group">
					  <label class="col-sm-2 control-label" >NISN</label>
					   <div class="col-sm-4">
					    ...
					    <div class="col-sm-4">
							<input type="text"  class="form-control" name="tgl_daftar"   value="<?php echo $santri['tgl_daftar']; ?>" id="single_cal1" >
						</div>
				...
				<div class="form-group">
				   ...
				   <?php
					...
					<div class="col-sm-10">
						...
						<label>
							<input type="radio" name="jenjang" value="SMP" class="flat-red form-control"  <?php if($santri['jenjang']=="SMP"){ echo "checked";} ?>> SMP
						</label>
						<label>
							<input type="radio" name="jenjang" value="MTs" class="flat-red form-control" <?php if($santri['jenjang']=="MTs"){ echo "checked";} ?>> MTs
						</label>
						<label>
							<input type="radio" name="jenjang" value="Paket B" class="flat-red form-control" <?php if($santri['jenjang']=="Paket B"){ echo "checked";} ?>> Paket B
						</label>
				...
				<div class="form-group">
					 ...
					 <div class="col-sm-10">
						  ...
						  <label>
						   ...
						   <label>
							  <input type="radio" name="penghasilan" value=">5000.000" class="flat-red form-control" <?php if($santri['penghasilan']==">5000.000"){ echo "checked";} ?>>>5000.000
						  </label>
